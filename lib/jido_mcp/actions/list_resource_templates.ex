defmodule Jido.MCP.Actions.ListResourceTemplates do
  @moduledoc "List resource templates for a configured MCP endpoint."

  use Jido.Action,
    name: "mcp_resources_templates_list",
    description: "List resource templates from an MCP endpoint",
    schema:
      Zoi.object(%{
  ...
  def run(params, context) do
    with {:ok, endpoint_id} <- Helpers.resolve_endpoint_id(params, context) do
      ...
      Jido.MCP.list_resource_templates(endpoint_id, opts)
    end
  end
